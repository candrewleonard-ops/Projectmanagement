// Electron main process for macOS — spawns the Next.js standalone server
// and loads it in a native desktop window.
...
function buildMenu() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: "About Reinnovation Homes",
...
app.on("window-all-closed", () => {
  ...
  // macOS convention: keep app alive until Cmd+Q
});
